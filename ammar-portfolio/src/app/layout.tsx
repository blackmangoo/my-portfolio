...
export const metadata: Metadata = {
  ...
  description: "Portfolio of Ammar Akbar, BS Artificial Intelligence student specializing in LLMs and Computer Vision.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased selection:bg-blue-500/30 selection:text-blue-200 relative`}
      >
