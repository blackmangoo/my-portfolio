    ...
    <div className={`flex flex-col gap-8 py-10 ${isFlagship ? "border-b border-[var(--color-border)] mb-12" : "mb-12"}`}>
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
        ...
        <div className="w-full lg:w-5/12">
          ...
          {/* Action CTAs: Live Demo + GitHub Source */}
          <div className="flex flex-wrap items-center gap-3">
            {project.liveUrl && (
              <motion.a
                ...
                className="inline-flex items-center gap-2 text-xs font-semibold px-4 py-2.5 bg-[var(--color-foreground)] text-[var(--color-background)] hover:bg-[var(--color-accent)] transition-colors rounded-sm shadow-sm min-h-[44px]"
              >
                <span>Launch Live 3D Experience</span>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-12">
            <div>
              ...
              <p className="text-[var(--color-muted)] max-w-2xl text-base sm:text-lg">
                End-to-end production systems covering interactive 3D WebGL, computer vision, autonomous agents, and high-performance backends.
              </p>
            </div>
